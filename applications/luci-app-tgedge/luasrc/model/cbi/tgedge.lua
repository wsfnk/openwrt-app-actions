...
m = taskd.docker_map("tgedge", "tgedge", "/usr/libexec/istorec/tgedge.sh",
	translate("甜果云 TiGO Edge"),
	"「甜果云 TiGO Edge 」由甜果云推出的一款 docker 容器镜像软件，通过在简单安装后即可快速加入甜果云，用户可根据每日的贡献量获得相应的现金收益回报。了解更多，请登录「<a href=\"https://www.tigocloud.cn/\" target=\"_blank\" >甜果云官网</a>」并查看<a href=\"https://doc.linkease.com/zh/guide/istoreos/software/tgedge.html\" target=\"_blank\">「教程」</a>")
